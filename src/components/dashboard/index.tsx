...
export const Logo = () => {
  return (
    ...
    >
      <IconDna2 size={30} className="text-white" />
      <motion.span
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
...
export const LogoIcon = () => {
  return (
    <Link
      ...
      className="font-normal flex space-x-2 items-center text-sm text-black py-1 relative z-20"
    >
      <IconDna2 size={35} className="text-white" />
    </Link>
  );
};
...
const Dashboard = () => {
  return (
    <div className="flex flex-1">
      <div className="p-2 md:p-10 rounded-tl-2xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-[#121212] flex flex-col gap-2 flex-1 w-full h-full">
